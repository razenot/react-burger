...
export const ingredientsSuccessCreator = (data: Array<TIngredient>): IIngredientsSuccessAction => ({
    type: GET_INGREDIENTS_SUCCESS,
    payload: data,
});

export const ingredientsFailedCreator = (error: string): IIngredientsFailedAction => ({
